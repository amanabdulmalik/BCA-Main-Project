...
class add_cr_scene(QWidget) :
    ...
    def cellClick(self,row, col):
        ...
        print(self.km)
        print(self.km[0][4])
        self.prk = self.km[0][0]


        qr=""
        pt = "D:\\object matching\\crime_sen_obj\\" + self.km[row][4]
        print(pt)
        self.img22 = pt
    ...
    def ad(self):
        ...
        c = conn()
        query = "select crime.crime_name,scene_no,scene_date,scene_time,scene_objects.path from crime_scene,crime,scene_objects where crime.cid=crime_scene.cr_id and scene_objects.scn_id=crime_scene.cid"
        print(query)
        ...
        for i in range(0, l1-1):
            ...
            #algo
            import cv2
            nw_pt = "D:\\object matching\\crime_sen_obj\\" + r[i][4]
            print(nw_pt)
            ...
            if (len(good_points) >= 24):
                print("dasa")
                yy22+=1
                self.t1.setRowCount(yy22)
